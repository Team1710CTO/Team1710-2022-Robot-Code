...
public class LedSubsystem extends SubsystemBase {
  ...
  public static int lastRed, lastBlue, lastGreen = 0;
  public LedSubsystem() {
  }

  public static AddressableLED m_led = new AddressableLED(2);

  public static AddressableLEDBuffer m_ledBuffer = new AddressableLEDBuffer(20);
