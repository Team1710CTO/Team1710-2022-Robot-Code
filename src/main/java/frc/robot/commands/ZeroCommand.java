...
public class ZeroCommand extends ParallelCommandGroup {
  ...
  public ZeroCommand(DrivetrainSubsystem drivetrainSubsystem, IntakeSubsystem intakeSubsystem, IndexerSubsystem indexerSubsystem, HoodSubsystem hoodSubsystem, GyroSubsystem gyroSubsystem) {
